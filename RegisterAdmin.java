...
public class RegisterAdmin extends HttpServlet {
    private static final String CHECK_EXISTING_USER_QUERY = 
        "SELECT COUNT(*) FROM user_Admin WHERE USERNAME=? OR EMAIL=? OR PHONENUMBER=?";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try (Connection con = getConnection();
            ...
            try (PreparedStatement ps = con.prepareStatement(INSERT_QUERY)) {
                ...
                if (count == 1) {
                    showSweetAlertRedirect(pw, "Registration Successful", "User registered successfully!", "success", "Userlogin.html");
                } else {
